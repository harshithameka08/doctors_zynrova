...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hi! I'm Zyncare Support. How can I help you with our services, doctor specialties, or booking procedures today?",
      sender: 'bot',
      ...
      <div className={`chatbot-window ${!isOpen ? 'hidden' : ''}`}>
        <div className="chatbot-header">
          ...
          <div className="chatbot-header-info">
            <h3>Zyncare Support <span className={`status-dot ${apiKey ? 'online' : 'offline'}`}></span></h3>
